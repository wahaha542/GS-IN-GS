...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], wm=False):
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            raise ValueError(f"Could not recognize scene type! Checked path: {args.source_path}\n"
                             f"Expected either 'sparse' directory or 'transforms_train.json' file in this path.")
