...
def replace_color_scale_info(low_contribution_vertices, ggbond_vertices, replacement_table):
    """将ggbond高斯球的颜色信息和缩放信息替换到低贡献高斯球中"""
    print("开始替换颜色和缩放信息...")
...
def main():
    ...
    output_path = r"D:\latest\new way\output\replace_cs\low_contribution_spheres_updated_color_scale.ply"
    replacement_table_path = r"D:\latest\new way\output\replace_cs\replacement_table.json"
    ...
    # 替换颜色和缩放信息
    new_low_contribution_vertices = replace_color_scale_info(
