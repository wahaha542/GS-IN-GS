...
def replace_rotation_info(low_contribution_vertices, ggbond_vertices, replacement_table):
    """将ggbond高斯球的旋转信息替换到低贡献高斯球中"""
    print("开始替换旋转信息...")
...
def main():
    ...
    output_path = r"D:\latest\new way\output\low_contribution_spheres_updated.ply"
    replacement_table_path = r"D:\latest\new way\output\replacement_table.json"
    ...
    # 替换旋转信息
    new_low_contribution_vertices = replace_rotation_info(
