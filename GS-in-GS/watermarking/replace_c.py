...
def replace_color_info(low_contribution_vertices, ggbond_vertices, replacement_table):
    """将ggbond高斯球的颜色信息替换到低贡献高斯球中"""
    print("开始替换颜色信息...")
...
def main():
    ...
    output_path = r"D:\latest\new way\output\replace_c\low_contribution_spheres_updated_color.ply"
    replacement_table_path = r"D:\latest\new way\output\replace_c\replacement_table_color.json"
    ...
    # 替换颜色信息
    new_low_contribution_vertices = replace_color_info(
