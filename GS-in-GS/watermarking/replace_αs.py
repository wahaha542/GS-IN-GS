...
def replace_opacity_scale_info(low_contribution_vertices, ggbond_vertices, replacement_table):
    """将ggbond高斯球的不透明度和缩放信息替换到低贡献高斯球中"""
    print("开始替换不透明度和缩放信息...")
...
def main():
    ...
    output_path = r"D:\latest\new way\output\replace_αs\low_contribution_spheres_updated_opacity_scale.ply"
    replacement_table_path = r"D:\latest\new way\output\replace_αs\replacement_table_opacity_scale.json"
    ...
    # 替换不透明度和缩放信息
    new_low_contribution_vertices = replace_opacity_scale_info(
