...
def replace_color_opacity_info(low_contribution_vertices, ggbond_vertices, replacement_table):
    """将ggbond高斯球的颜色和不透明度信息替换到低贡献高斯球中"""
    print("开始替换颜色和不透明度信息...")
...
def main():
    ...
    output_path = r"D:\latest\new way\output\replace_cα\low_contribution_spheres_updated_color_opacity.ply"
    replacement_table_path = r"D:\latest\new way\output\replace_cα\replacement_table_color_opacity.json"
    ...
    # 替换颜色和不透明度信息
    new_low_contribution_vertices = replace_color_opacity_info(
