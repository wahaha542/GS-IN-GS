...
def replace_opacity_info(low_contribution_vertices, ggbond_vertices, replacement_table):
    """将ggbond高斯球的不透明度信息替换到低贡献高斯球中"""
    print("开始替换不透明度信息...")
...
def main():
    ...
    output_path = r"D:\latest\new way\output\replace_α\low_contribution_spheres_updated_opacity.ply"
    replacement_table_path = r"D:\latest\new way\output\replace_α\replacement_table_opacity.json"
    ...
    # 替换不透明度信息
    new_low_contribution_vertices = replace_opacity_info(
