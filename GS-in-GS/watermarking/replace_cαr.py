...
def replace_color_opacity_rotation_info(low_contribution_vertices, ggbond_vertices, replacement_table):
    """将ggbond高斯球的颜色信息、不透明度和旋转信息替换到低贡献高斯球中"""
    print("开始替换颜色、不透明度和旋转信息...")
...
def main():
    ...
    replacement_table_path = r"D:\latest\new way\output\replace_cαr\replacement_table.json"
    ...
    # 替换颜色、不透明度和旋转信息
    new_low_contribution_vertices = replace_color_opacity_rotation_info(
