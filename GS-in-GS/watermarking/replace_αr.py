...
def replace_opacity_rotation_info(low_contribution_vertices, ggbond_vertices, replacement_table):
    """将ggbond高斯球的不透明度和旋转信息替换到低贡献高斯球中"""
    print("开始替换不透明度和旋转信息...")
...
def main():
    ...
    output_path = r"D:\latest\new way\output\replace_αr\low_contribution_spheres_updated_opacity_rotation.ply"
    replacement_table_path = r"D:\latest\new way\output\replace_αr\replacement_table_opacity_rotation.json"
    ...
    # 替换不透明度和旋转信息
    new_low_contribution_vertices = replace_opacity_rotation_info(
