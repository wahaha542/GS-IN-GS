...
def replace_scale_info(low_contribution_vertices, ggbond_vertices, replacement_table):
    """将ggbond高斯球的缩放信息替换到低贡献高斯球中"""
    print("开始替换缩放信息...")
...
def main():
    ...
    output_path = r"D:\latest\new way\output\replace_s\low_contribution_spheres_updated_scale.ply"
    replacement_table_path = r"D:\latest\new way\output\replace_s\replacement_table_scale.json"
    ...
    # 替换缩放信息
    new_low_contribution_vertices = replace_scale_info(
